...
weight: 1
draft: false
lastmod: 2025-01-13T17:38:14+08:00
---
## 知识性的书籍总结
...
2. 对人物，你需要关注的有外貌、身份等；对地点，你需要关注它的位置、作用等；对于时间，只记录对剧情发展有关键作用的即可。
3. 每出现一次对某一人、事、物的描写，都应整理成该项下的一个要点。
4. 所有的信息不一定会一次性全部出现，可能会随着剧情的发展逐步完善。对于那些当前信息非常少的人物、地名或是建筑，比如只在他人的对话中提了一下，或者只是在某句话中出现了一次等等，你只需记录已有的信息即可。但是注意，你可以少写，甚至只记一个名字，但不能不记，因为他们在后续的剧情中可能有重要的作用。
